...
import { Project1Data, Project2Data } from "./ProjectsDetails";
import ProjectWidget from "./ProjectWidget";

const ProjectsSectionContainer = tw.div`
    w-full flex bg-gradient-to-tl from-yellow-200 via-yellow-300 to-yellow-400 justify-center
`;

const ContentWrapper = tw.div`
  flex flex-col self-center lg:max-width[1000px] 2xl:max-width[1200px] h-full
  mt-12 mb-12 sm:mr-12 sm:ml-12 border-radius[10px] relative w-full gap-4 sm:gap-16
`;
